const Tokenomics = () => {
  return (
    <div className='bg-white mt-4 rounded-md p-3 max-w-[881px]'>
      <h2 className='text-2xl font-semibold'>Tokenomics</h2>
      <h4 className='font-semibold mt-3'>Initial Distribution</h4>
      <div className="mt-3">
        <p className="flex items-center">
          <span className="bg-blue-500 rounded-full h-[12px] w-[12px] mr-2"></span>
          <span>Crowdsale investors: 80%</span>
        </p>
        <p className="flex items-center">
          <span className="bg-yellow-500 rounded-full h-[12px] w-[12px] mr-2"></span>
